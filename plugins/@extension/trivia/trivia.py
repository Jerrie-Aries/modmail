...
from core.utils import bold, code_block, normalize_smartquotes, plural
...
class TriviaSession:
    ...
    async def wait_for_answer(
        self, answers: List[str], delay: float, timeout: float
    ) -> bool:
        """
...
class Trivia(commands.Cog):
    ...
    def _get_leaderboard(
        data: Dict[discord.Member, Dict[str, Any]], key: str, top: int
    ) -> str:
